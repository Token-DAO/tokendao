...
def forecast(df, params, halvening_dates, daily_average_mined, daily_std_mined, halving_divisor=2):
    """
    ...
    :param halving_divisor: (int) Divisor applied to block reward during halving events. Defaults to 2.
